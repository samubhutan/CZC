...
<section class="cta-area-2 position-relative space-bottom">
    ...
    <div class="container">
                                        ...
                                        <div class="course-content">
                                            ...
                                            <div class="course-meta">
                                                <?php if (get_field('bqfc_level')): ?>
                                                    <span><i class="fal fa-file"></i> <strong class="text-uppercase"><?php echo esc_html(get_field('bqfc_level')); ?></strong></span>
                                                <?php endif; ?>
                                                <?php if (get_field('category')): ?>
                                                    <span><i class="fal fa-chart-simple"></i> <?php echo esc_html(get_field('category')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="text-center">
            <a href="<?php echo site_url('/courses'); ?>" class="th-btn">དབུལ་གྱི་ལས་ཁུངས་ཚུ<i class="fa-solid fa-arrow-right ms-2"></i></a>
        </div>
    </div>
</section>
