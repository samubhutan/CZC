<ul>
    ...
    <li class="menu-item-has-children">
        <a href="<?php bloginfo('url'); ?>/about-us/"> ང་བཅས་ཀྱི་སྐོར།</a>
        <ul class="sub-menu">
            <?php
            ...
            <li><a href="<?php bloginfo('url'); ?>/about-us">དམིགས་སྐྱེད། & འཆར་སྣང་།</a></li>
            <li><a href="<?php bloginfo('url'); ?>/about-us">བརྩི་མཐོང༌།</a></li>
            <li><a href="<?php bloginfo('url'); ?>/about-us/faculty-profile/">Faculty Profile</a></li>
        </ul>
    </li>
    <li>
        <a href="<?php bloginfo('url'); ?>"> སྦྱོང་ཚན་ཚུ།</a>
    </li>
    <li class="menu-item-has-children">
        <a href="#"> སློབ་ཕྲུག་ཞབས་ཞུ།</a>
        <ul class="sub-menu">
    ...
    <li class="menu-item-has-children">
        ...
        <ul class="sub-menu">
            <li><a href="<?php bloginfo('url'); ?>">འབྲི་ཤོག།</a></li>
            <li><a href="<?php bloginfo('url'); ?>">དཔེ་སྐྲུན།</a></li>
        </ul>
    </li>
    <li>
